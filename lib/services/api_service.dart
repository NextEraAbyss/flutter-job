...
class ApiService {
  ...
  static Future<List<NewsItem>> getNewsList() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/v1/news?page=1&page_size=10'),
        headers: headers,
      );
  ...
  static Future<List<JobPosition>> getJobPositions() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/v1/jobs?page=1&page_size=10'),
        headers: headers,
      );
  ...
  static Future<JobPosition> getJobDetail(int id) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/v1/jobs/$id'),
        headers: headers,
      );
