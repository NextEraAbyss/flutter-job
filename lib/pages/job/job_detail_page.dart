                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16.0),
                              if (_jobPosition!.requirements != null && _jobPosition!.requirements!.isNotEmpty)
                                ...(_jobPosition!.requirements!.map((req) => _buildRequirementItem(req)))
                              else
                                ...[
                                  _buildRequirementItem('1. 本科及以上学历，计算机相关专业；'),
                                  _buildRequirementItem('2. 5年以上Java开发经验，熟练掌握Java核心技术；'),
                                  _buildRequirementItem('3. 熟悉Spring、SpringBoot、MyBatis等主流框架；'),
                                  _buildRequirementItem('4. 熟悉MySQL等关系型数据库，具有良好的SQL编写能力；'),
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(content: Text('申请已提交，请等待HR联系')),
                                    );
                                  },
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Colors.teal, // 改为绿色
